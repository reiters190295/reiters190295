    ...
    private static class ReciprocalArraySumTask extends RecursiveTask<Double>
    {
        ...
        protected Double compute() {
            ...
            else
            {
                ...
                double[] d1 = new double[input.length/2 +i];
                double[] d2 = new double[input.length/2];

                ReciprocalArraySumTask left = new ReciprocalArraySumTask(startIndexInclusive,endIndexExclusive/2 +i, d1);
                ReciprocalArraySumTask right = new ReciprocalArraySumTask(endIndexExclusive/2 +i+1,endIndexExclusive,d2);
